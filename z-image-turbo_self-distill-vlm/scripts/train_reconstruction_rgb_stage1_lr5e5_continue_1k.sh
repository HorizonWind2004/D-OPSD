...
RESUME_LORA="${RESUME_LORA:-/mnt/hdfs/jixie/checkpoints/zimage_reconstruction_train/rgb_stage1_zimage_reca_style_lora_lr5e5_1k/checkpoints/step_001000/recon}"
...
"${ACCELERATE_BIN}" launch \
  ...
  --main_process_port "${MAIN_PROCESS_PORT:-39525}" \
  ...
  --exp-name "rgb_stage1_zimage_reca_style_lora_lr5e5_2k_continue_from1k" \
  --resolution 256 \
  --vl-resolution 224 \
  --image-count 100000 \
